...
/// 매장 상세 (STEP 1 mock) — 매장 정보 + 진행 중 오리파 리스트.
            ...
            child: Row(
              children: [
                const AppSquircleIcon(
                    icon: Icons.storefront_rounded, color: AppColors.blue, size: 40),
...
class _OripaCard extends StatelessWidget {
  ...
  const _OripaCard({required this.oripa, required this.onTap});
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            OripaSlotBar(oripa.soldFraction),
            const SizedBox(height: 6),
            Row(
              children: [
                Text('남은 ${oripa.remainingSlots}/${oripa.totalSlots}구',
                    style: AppText.caption),
                const Spacer(),
