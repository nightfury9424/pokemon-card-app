...
import {
  ...
  TrendingUp, ScanLine, LogOut, AlertTriangle, Flag, Mail, Gavel, ScrollText, Megaphone, Calculator
} from 'lucide-react'
import api from '../api'
...
const nav = [
  ...
  { to: '/notices',   icon: Megaphone,       label: '공지 관리' },
  ...
  { to: '/pull-rate', icon: Calculator,      label: '확률 계산기' },
