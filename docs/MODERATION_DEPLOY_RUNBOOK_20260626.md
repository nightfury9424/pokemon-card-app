...
**Front 수정 완료 + 새 IPA(최종본)**: trade_search placeholder `카드명 / 세트 / 등급으로 검색` → `카드명 또는 세트명으로 검색`(커밋 25782fd2·문자열만·전수 그 한 곳). flutter test 226/0. 검색 placeholder(202606261035) + **신고 화면 키보드 대응**(report_sheet: FocusNode+ScrollController, 입력 포커스 시 입력+카운터+신고버튼이 키보드 위로 자동 스크롤, 사유선택 점프 없음, cancelable Timer; test 226/0). **최종 IPA = `front.ipa` 46.6MB·버전 1.0.4·build `202606262014`·arm64-only·SHA-256 `f77ba9c57d9987ae9ae0079b6d9e0e36e9148a1a52a68dffc2958946cece8c3b`**(202606261035·202606260712 폐기).
