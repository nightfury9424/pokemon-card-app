...
## B3-13. 신고 비가역 고지 (신중 신고 + 허위신고 제재) — [x] DONE
**현상**: "신고하고 차단할까요?" 다이얼로그가 자동 차단/관리자 확인만 안내. 신고는 접수되면 **취소 불가**(차단만 해제 가능)인데 그 고지가 없음 → 충동/허위 신고 위험. (Image #37)
**수정(프론트 문구)**: 3곳 통일 —
- 챗 신고 confirm 다이얼로그(chat_room) + 챗 신고 시트 notice + 거래상세 신고 notice
- 추가 문구: "차단은 해제할 수 있지만 접수된 신고는 취소되지 않아요. 신중하게 신고해 주세요. 허위·악의적 신고는 이용 제재 대상이 될 수 있습니다." (약관 §위반·허위신고 제재 조항과 정합)
