...
### [~] 3. 프로필 편집 (프론트✓ 카드탭→편집, 사진업로드=post-launch) (프로필 카드 탭 → 닉네임 + 프로필 사진 변경)
...
### [~] 5. 문의 플로우 (5-1·5-2·5-3 프론트✓, 5-4 알림=백엔드 남음)
...
### [x] 6. 홈 로딩 — 사용자 테스트 [O](스켈레톤 즉시·2장 부드럽게) = 해결
...
## 🔵 Post-launch (분리)
- [x] **전화번호 저장 = 풀번호 평문 유지로 결정**(2026-06-04). 암호화/삭제 안 함. 사유: 법적·분쟁 대응(수사기관 적법요청 시 제공, 방침 제4조). 전번은 PIPA 의무암호화 대상 아님 → 평문 합법. **코드 변경 없음(현재 그대로).**
