...
| 영역 | Y (팩 높이 %) | 용도 | 제약 |
|------|--------------|------|------|
| 상단 크림프/절취 | 0–10% | **비움** | 절취 애니 영역, 콘텐츠 금지 |
| 플랫폼 워드마크 | 11–16% | `POKEFOLIO`(고정) | 소형·중앙 |
| 매장 로고 | 18–34% | `merchantLogoUrl` | 박스 ≤ 폭 55% × 높이 14% |
| 중앙 아트 | 36–62% | `merchantArtworkUrl`(선택) | ≤ 폭 64% |
| 오리파명 | 70–84% | `oripaTitle` | ≤ 폭 72%, 최대 2줄 |
| 하단 크림프 | 90–100% | **비움** | 콘텐츠 금지 |
- 좌우: 콘텐츠 x 10–90%(실링 seam 침범 금지). B 템플릿은 골드 프레임 내부(약 x12–88%, y12–88%)에 배치.
