...
**현재 사이클 (2026-07-06)**: iOS **1.0.7 출시/배포 완료 — 릴리즈 트랙 CLOSED** (토스 디자인 전면 개선, main@6a993b8b). 현재 = **1.2.0 오리파 플랫폼** 신규 개발 트랙(오프라인 매장 입점 중개). STEP 1 = Flutter mock 화면 TestFlight 실기기 확인 중(`feat/oripa-1.2.0` 워크트리). 상세는 `docs/SESSION_HANDOFF.md`. ※"1.0.7 심사 중" 등 과거 표현은 historical — 현재상태 추론 금지. App Review 분석은 사용자 명시 요청 시만.
